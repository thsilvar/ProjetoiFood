                    ...
                    <c:forEach items="${produtos}" var="produto">
                        <tr>
                            ...
                            <td><a class="btn btn-primary btn-sm" href=
                                   "ManterProdutoController?acao=prepararOperacao&operacao=Editar&codProduto=<c:out value="${produto.id}"/>">Editar</a></td>
                            <td><a class="btn btn-danger btn-sm" href=
                                   "ManterProdutoController?acao=prepararOperacao&operacao=Excluir&codProduto=<c:out value="${produto.id}"/>">Excluir</a></td>
                        </tr>
                    </c:forEach>
                </tbody>
            </table>
